...
import { nfEntradaLogController } from '../../../core/nf-entrada-log/nf-entrada-log_controller.mjs'
import { produtoPlanoControleController } from '../../../core/produto-plano-controle/produto-plano-controle_controller.mjs'
import { produtoEstatisticaController } from '../../../core/produto-plano-estatistica/produto-estatistica_controller.mjs'
...
export const createTransferencia = (
  ...
  async function createTransferencia({ controles }) {
