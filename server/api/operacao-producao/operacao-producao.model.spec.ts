...
describe("nfSaidaFvModel", () => {
  ...
  it("diario", async () => {
    const rsp = await operacaoProducao.query.operacaoProducaoDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      operacao: "3020",
    });
  ...
  it("mensal", async () => {
    const rsp = await operacaoProducao.query.operacaoProducaoMensal({
      mes: "2020-01",
      operacao: "3020",
    });
    expect(rsp).toEqual([{ quantidade: 1 }]);
  ...
  it("modelo", async () => {
    const rsp = await operacaoProducao.query.operacaoProducaoModelo({
      data: "2020-01-01",
      operacao: "3020",
      produto: "produto",
    });
  ...
  it("produto", async () => {
    const rsp = await operacaoProducao.query.operacaoProducaoProduto({
      data: "2020-01-01",
      operacao: "3020",
    });
    expect(rsp).toEqual([{ quantidade: 1 }]);
  ...
  it("turno", async () => {
    const rsp = await operacaoProducao.query.operacaoProducaoTurno({
      data: "2020-01-01",
      operacao: "3020",
    });
    expect(rsp).toEqual([{ quantidade: 1 }]);
