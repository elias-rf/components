...
describe("esterilizacaoEsterna", () => {
  ...
  test("diario", async () => {
    const rsp = await estExterna.query.esterilizacaoExternaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
  ...
  test("mensal", async () => {
    const rsp = await estExterna.query.esterilizacaoExternaMensal({
      mes: "2020-01",
    });
  ...
  test("modelo", async () => {
    const rsp = await estExterna.query.esterilizacaoExternaModelo({
      data: "2020-01-01",
      produto: "Metil",
    });
  ...
  test("produto", async () => {
    const rsp = await estExterna.query.esterilizacaoExternaProduto({
      data: "2020-01-01",
    });
