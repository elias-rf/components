...
describe("nfSaidaFvModel", () => {
  ...
  it("vendaDiario", async () => {
    const rsp = await nfSaida.query.nfSaidaFvVendaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      uf: ["MG"],
    });
  ...
  it("vendaMensal", async () => {
    const rsp = await nfSaida.query.nfSaidaFvVendaMensalCliente({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      cliente: 123,
    });
  ...
  it("vendaAnalitico", async () => {
    const rsp = await nfSaida.query.nfSaidaFvVendaAnalitico({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
    expect(rsp).toEqual([
