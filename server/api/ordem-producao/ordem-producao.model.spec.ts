...
describe("ordemProducaoModel", () => {
  ...
  it("produtoItem", async () => {
    const rsp = await ordemProducao.query.ordemProducaoProdutoItem({
  ...
  // it("produto", async () => {
  //   const rsp = await ordemProducao.query.ordemProducaoProduto({
  //     id: { ordem_producao_id: 1 },
  //     select: ["produto_id"],
  //   });
  ...
  it("dataFabricacao", async () => {
    const rsp = await ordemProducao.query.ordemProducaoDataFabricacao({
      id: { ordem_producao_id: 1 },
    });
  ...
  it("dataValidade", async () => {
    const rsp = await ordemProducao.query.ordemProducaoDataValidade({
      id: { ordem_producao_id: 1 },
    });
  ...
  it("produtoPlano", async () => {
    const rsp = await ordemProducao.query.ordemProducaoProdutoPlano({
      id: { ordem_producao_id: 1 },
  ...
  it("controle", async () => {
    const rsp = await ordemProducao.query.ordemProducaoControle({
  ...
  it("isControleValid true", async () => {
    const rsp = await ordemProducao.query.ordemProducaoIsControleValid({
