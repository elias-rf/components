...
describe("nfSaidaModel", () => {
  ...
  it("transferenciaDiario", async () => {
    const rsp = await nfSaida.query.nfSaidaTransferenciaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
  ...
  it("transferenciaMensal", async () => {
    const rsp = await nfSaida.query.nfSaidaTransferenciaMensal({
      mes: "2020-01",
    });
  ...
  it("transferenciaModelo", async () => {
    const rsp = await nfSaida.query.nfSaidaTransferenciaModelo({
      data: "2020-01-01",
    });
  ...
  it("vendaDiario", async () => {
    const rsp = await nfSaida.query.nfSaidaVendaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      uf: ["MG"],
    });
  ...
  it("vendaMensal", async () => {
    const rsp = await nfSaida.query.nfSaidaVendaMensalCliente({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      cliente: 123,
    });
  ...
  it("vendaAnalitico", async () => {
    const rsp = await nfSaida.query.nfSaidaVendaAnalitico({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
    expect(rsp).toEqual([
