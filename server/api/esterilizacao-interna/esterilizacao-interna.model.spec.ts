...
describe("esterilizacaoInterna", () => {
  ...
  test("diario", async () => {
    const rsp = await estInterna.query.esterilizacaoInternaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
  ...
  test("mensal", async () => {
    const rsp = await estInterna.query.esterilizacaoInternaMensal({
      mes: "2020-01",
    });
  ...
  test("modelo", async () => {
    const rsp = await estInterna.query.esterilizacaoInternaProduto({
      data: "2020-01-01",
    });
