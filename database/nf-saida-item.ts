...
export class NfSaidaItem extends ModelBase {
  static tableName = "ItemNota";
  static idColumn = ["CdFilial", "NumNota", "Serie", "Modelo", "Sequencia"];
...
NfSaidaItem.knex(connections.plano);

export type TNfSaidaItem = ModelObject<NfSaidaItem>;
