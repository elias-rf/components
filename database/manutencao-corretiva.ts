...
export class ManutencaoCorretiva extends ModelBase {
...
ManutencaoCorretiva.knex(connections.oftalmo);

export type TManutencaoCorretiva = ModelObject<ManutencaoCorretiva>;
