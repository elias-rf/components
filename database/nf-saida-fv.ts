...
export class NfSaidaFv extends ModelBase {
  static tableName = "MestreNota";
  static idColumn = ["CdFilial", "NumNota", "Serie", "Modelo", "Tipo"];
...
NfSaidaFv.knex(connections.fullvision);

export type TNfSaidaFv = ModelObject<NfSaidaFv>;
