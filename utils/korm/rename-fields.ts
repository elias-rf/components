 ...
 * @return {*}
 */
export function renameToFieldTuple(
  tupleArray: any[],
  fields: Record<string, string>
) {
  if (isEmpty(tupleArray)) return tupleArray;
  const nameList = Object.values(fields);
...
export function renameToFieldArray(data: any, fields: Record<string, string>) {
  if (isEmpty(data)) return data;
  const nameList = Object.values(fields);
  const fieldList = Object.keys(fields);
...
export function renameToNameObject(data: any, fields: Record<string, string>) {
  if (!isObject(data)) return data;
  const nameList = Object.values(fields);
  const fieldList = Object.keys(fields);
...
export function renameToFieldObject(data: any, fields: Record<string, string>) {
  if (!isObject(data)) return data;
  const nameList = Object.values(fields);
  const fieldList = Object.keys(fields);
...
export function renameToNameArrayObject(
  data: any[],
  fields: Record<string, string>
) {
...
export function renameToFieldArrayObject(
  data: any[],
  fields: Record<string, string>
) {
  if (!isArray(data)) return data;
...
export function renameFieldToName(data: any, fields: Record<string, string>) {
  const nameList = Object.values(fields);
  const fieldList = Object.keys(fields);
...
export function renameNameToField(data: any, fields: Record<string, string>) {
  const nameList = Object.values(fields);
  const fieldList = Object.keys(fields);
