import { nfSaidaLoteUseCases } from '@/core/nf-saida-lote/use-cases/index.js'
...
export type TNfSaidaLoteController = typeof nfSaidaLoteController
...
//   produto: {
//     method: () =>
//       import('../produto/produto-plano/produto-plano_controller.js').then(
