...
import { PrecosVendedor } from './precos-vendedor.jsx'
import { Textbox } from './textbox.jsx'
import { usePrecosState } from './use-precos.state.mjs'
...
function Produto({ produto, recalc, snap }) {
...
export function PrecosCliente({ className }) {
  const [snap, setValue] = usePrecosState()
  ...
  return (
    <>
      <div className={cn('flex flex-col', className)}>
        ...
        <div className="my-2 w-min border border-solid border-black bg-gray-100 p-4">
