...
const fetchEsterilizacaoInternaDiario = async (mes) => {
...
const fetchEsterilizacaoInternaMensal = async (mesInicio) => {
  const params = {
...
const fetchEsterilizacaoInternaModelo = async (dia, produto) => {
  const params = {
...
const fetchEsterilizacaoInternaProduto = async (dia) => {
  const params = {
    data: getFieldId('dia', dia),
  }
