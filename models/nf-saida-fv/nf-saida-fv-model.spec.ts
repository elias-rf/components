...
describe("nfSaidaFvModel", () => {
  ...
  it("vendaDiario", async () => {
    ...
    const rsp = await modelsMock.nfSaidaFv.vendaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      uf: ["MG"],
    });
  ...
  it("vendaMensal", async () => {
    const rsp = await modelsMock.nfSaidaFv.vendaMensalCliente({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      cliente: 123,
    });
  ...
  it("vendaAnalitico", async () => {
    const rsp = await modelsMock.nfSaidaFv.vendaAnalitico({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
    expect(rsp).toEqual([
