...
describe("nfSaidaModel", () => {
  ...
  it("transferenciaDiario", async () => {
    ...
    const rsp = await modelsMock.nfSaida.transferenciaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
  ...
  it("transferenciaMensal", async () => {
    ...
    const rsp = await modelsMock.nfSaida.transferenciaMensal({
      mes: "2020-01",
    });
  ...
  it("transferenciaModelo", async () => {
    ...
    const rsp = await modelsMock.nfSaida.transferenciaModelo({
      data: "2020-01-01",
    });
  ...
  it("vendaDiario", async () => {
    ...
    const rsp = await modelsMock.nfSaida.vendaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      uf: ["MG"],
    });
  ...
  it("vendaMensalCliente", async () => {
    ...
    const rsp = await modelsMock.nfSaida.vendaMensalCliente({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      cliente: 123,
    });
  ...
  it("vendaAnalitico", async () => {
    ...
    const rsp = await modelsMock.nfSaida.vendaAnalitico({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
    expect(rsp).toEqual([
