...
describe("nfSaidaModel", () => {
  ...
  it("transferenciaDiario", async () => {
    ...
    const rsp = await nfSaidaModel.transferenciaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
  ...
  it("transferenciaMensal", async () => {
    ...
    const rsp = await nfSaidaModel.transferenciaMensal({
      mes: "2020-01",
    });
  ...
  it("transferenciaModelo", async () => {
    ...
    const rsp = await nfSaidaModel.transferenciaModelo({
      data: "2020-01-01",
    });
  ...
  it("vendaDiario", async () => {
    ...
    const rsp = await nfSaidaModel.vendaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      uf: ["MG"],
    });
  ...
  it("vendaMensalCliente", async () => {
    ...
    const rsp = await nfSaidaModel.vendaMensalCliente({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      cliente: 123,
    });
  ...
  it("vendaAnalitico", async () => {
    ...
    const rsp = await nfSaidaModel.vendaAnalitico({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
    expect(rsp).toEqual([
