...
describe("nfSaidaFvModel", () => {
  ...
  NfSaidaFv.knex(connectionsMock.plano);
  ...
  it("vendaDiario", async () => {
    ...
    const rsp = await nfSaidaFvModel.vendaDiario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      uf: ["MG"],
    });
  ...
  it("vendaMensal", async () => {
    const rsp = await nfSaidaFvModel.vendaMensalCliente({
      inicio: "2020-01-01",
      fim: "2020-01-31",
      cliente: 123,
    });
  ...
  it("vendaAnalitico", async () => {
    const rsp = await nfSaidaFvModel.vendaAnalitico({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
    expect(rsp).toEqual([
