...
class OrdemProducaoOperacaoModel extends CrudObjection {
  constructor() {
    super(OrdemProducaoOperacao);
  }
...
export const ordemProducaoOperacaoModel = new OrdemProducaoOperacaoModel();
