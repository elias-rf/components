...
describe("esterilizacaoInterna", () => {
  ...
  test("diario", async () => {
    ...
    const rsp = await esterilizacaoExternaModel.diario({
      inicio: "2020-01-01",
      fim: "2020-01-31",
    });
  ...
  test("mensal", async () => {
    ...
    const rsp = await esterilizacaoExternaModel.mensal({
      mes: "2020-01",
    });
  ...
  test("modelo", async () => {
    tracker.on.select("tEsterilizacaoExterna").response([]);
    const rsp = await esterilizacaoExternaModel.modelo({
      data: "2020-01-01",
      produto: "1",
    });
  ...
  test("produto", async () => {
    tracker.on.select("tEsterilizacaoExterna").response([]);
    const rsp = await esterilizacaoExternaModel.produto({
      data: "2020-01-01",
    });
