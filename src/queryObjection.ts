...
function renameIgualdade(filtro: any) {
...
function loopWhere(filtro: any, knex) {
  const flt = filtro;
 ...
 */
function queryObjection(qry: any, model: any) {
  const q = qry;
  let qb = model.query();
