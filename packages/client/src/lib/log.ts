var _ = require("lodash"),
  ...
  loggerHelper = require("./loghelper"),
  setupOptions: any,
  flatten = require("flat");

var audit = function (req: any, res: any, next: any) {
...
export default function log(options?: any) {
  options = options || {};
  var defaults = {
    logger: logger,
    request: {
...
function validateArrayFields(options: any, defaults: any) {
...
function setBodyLengthFields(options: any) {
  const isValid = (field: any) => field && !isNaN(field) && field > 0;
  options.request.maxBodyLength = !isValid(options.request.maxBodyLength)
    ? undefined
    : options.request.maxBodyLength;
